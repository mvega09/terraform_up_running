terraform {
  required_version = ">= 1.0.0" // Version minimum recommended of Terraform
  required_providers {
    aws = {
      source  = "hashicorp/aws" // Proveedor oficial de AWS
      version = "~> 6.0"        // Version recomendada del proveedor AWS
    }
  }
}
...
// Obtains the availability zones available in the selected region
